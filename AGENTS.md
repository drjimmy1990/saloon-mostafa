...
This project is indexed by GitNexus as **saloon-mostafa** (1696 symbols, 3124 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
