...
export const translations = {
  en: {
    ...
    services: {
      ...
      publishNow: "Immediately",
      publishAfter1Day: "After 1 day",
      publishAfter2Days: "After 2 days",
      publishAfter3Days: "After 3 days",
      publishAfter1Week: "After 1 week",
  ...
  ar: {
    ...
    services: {
      ...
      byQueue: "🔢 بالدور",
      deposit: "العربون (JOD)",
      publishTiming: "وقت النشر",
      publishNow: "حالاً",
      publishAfter1Day: "بعد يوم",
      publishAfter2Days: "بعد يومين",
      publishAfter3Days: "بعد 3 أيام",
      publishAfter1Week: "بعد أسبوع",
